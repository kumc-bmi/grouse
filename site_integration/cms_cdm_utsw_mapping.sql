-- cms_cdm_utsw_mapping.sql: create a mapping to integrate CMS data and blueheron data
...
select count(*) from utsw_cdm.patient_hash_map;
...
select * from utsw_cdm.patient_hash_map;
...
drop table cms_id.cms_cdm_utsw_mapping;
create table cms_id.cms_cdm_utsw_mapping as 
...
(
  ...
  join utsw_cdm.patient_hash_map mp 
