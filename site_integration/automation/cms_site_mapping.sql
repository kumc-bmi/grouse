...
select count(*) from "&&I2B2_SITE_SCHEMA".patient_hash_map;

select * from "&&I2B2_SITE_SCHEMA".patient_hash_map;
select * from cms_id."&&unique_bene_xwalk_11_15" xw;
select * from cms_id."&&bene_id_mapping_11_15" gpd;
...
drop table cms_id."&&unique_bene_xwalk_11_15";
create table cms_id."&&out_cms_site_mapping_year" as 
